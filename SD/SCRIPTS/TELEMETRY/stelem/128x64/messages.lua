...
local function scrollBar(scrollpos, scrollref)
  ...
  lcd.drawFilledRectangle(0, 0, w, shared.screenH, DARKGREY)
  lcd.drawFilledRectangle(0, scrollpos, w, 5, LIGHTWHITE)
end
...
function shared.run(event)
  ...
  do
    if shared.Messages[i] ~= nil then
      lcd.drawText(2, line, tostring(shared.Messages[i]), SMLSIZE)
    end
    line = line + 7
  end
